  ...
  roles: {
    ...
    [ids.managerRole]: {
      ...
      permissions: [
        // Dashboard
        'dashboard:view',
        // Operations (pas de manage general, mais peut gérer son site)
        'operations:view',
        'farmmap:view',
        'calendar:view',
        'sites:view',
        ...
        // Reports
        'reports:view'
        // PAS de settings système, users, roles
      ],
      createdAt: new Date().toISOString()
    },
    [ids.employeeRole]: {
      ...
      permissions: [
        ...
        'drying:view',
        'bagging:view',
        // Inventory (lecture + saisie basique)
        'inventory:view',
        'inventory:manage:on_site',
        'inventory:manage:deliveries',
        ...
        'employees:view',
        'providers:view',
        // Monitoring (lecture + saisie incidents)
        'monitoring:view',
        'tests:view',
        'incidents:view',
        'incidents:manage',
