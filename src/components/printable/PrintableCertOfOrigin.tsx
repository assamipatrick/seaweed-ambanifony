    ...
    return (
        <PrintPage>
            <div className="border-2 border-black p-4 text-black">
                ...
                <table className="w-full border-collapse text-xs text-black" style={THIN_BORDER_STYLE}>
                    <tbody>
                        <tr>
                            <td className="p-2 w-1/2 align-top" style={THIN_BORDER_STYLE}>
                                <p className="font-bold">1. {t('exporter')}</p>
                                <p className="pl-4">{settings.company.name}</p>
                                <p className="pl-4">{settings.company.address}</p>
                            </td>
                            <td className="p-2 w-1/2 align-top" rowSpan={2} style={THIN_BORDER_STYLE}>
                                <p className="font-bold text-center mt-4">{t('CERTIFICATE_OF_ORIGIN').toUpperCase()}</p>
                        ...
                        <tr>
                            <td colSpan={2} className="p-2 align-top" style={THIN_BORDER_STYLE}>
                        ...
                        <tr>
                            <td className="p-2 font-bold align-top" style={THIN_BORDER_STYLE}>4. {t('marksAndNumbers')}</td>
                            <td className="p-2 font-bold align-top" style={THIN_BORDER_STYLE}>5. {t('packagesAndDescription')}</td>
                        </tr>
                        <tr>
                            <td className="p-2 align-top h-24" style={THIN_BORDER_STYLE}>
                        ...
                        <tr>
                            <td className="p-2 font-bold align-top" style={THIN_BORDER_STYLE}>6. {t('originCriterion')}</td>
                            <td className="p-2 font-bold align-top" style={THIN_BORDER_STYLE}>7. {t('quantity')}</td>
                        </tr>
                         <tr>
                            <td className="p-2 align-top h-16" style={THIN_BORDER_STYLE}>{t('originCriterionA')}</td>
                            <td className="p-2 align-top h-16" style={THIN_BORDER_STYLE}>
                        ...
                        <tr>
                            <td className="p-2 font-bold align-top" style={THIN_BORDER_STYLE}>8. {t('invoiceNumberAndDate')}</td>
                            <td className="p-2 font-bold align-top" style={THIN_BORDER_STYLE}>9. {t('remarks')}</td>
                        </tr>
                         <tr>
                            <td className="p-2 align-top h-12" style={THIN_BORDER_STYLE}>{doc.invoiceNo} / {doc.date}</td>
                            <td className="p-2 align-top h-12" style={THIN_BORDER_STYLE}></td>
                        </tr>
                        <tr>
                            <td className="p-2 align-top h-32" style={THIN_BORDER_STYLE}>
