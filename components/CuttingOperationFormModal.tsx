...
const CuttingOperationFormModal: React.FC<CuttingOperationFormModalProps> = ({ isOpen, onClose, operation }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        beneficiaryFarmerId: undefined as string | undefined
    });
    ...
    const beneficiaryFarmers = useMemo(() => {
        ...
        if (formData.beneficiaryFarmerId) {
             const farmerName = farmerMap.get(formData.beneficiaryFarmerId);
             return farmerName ? [farmerName] : [];
        }
    ...
    }, [formData.moduleCuts, formData.beneficiaryFarmerId, modules, farmerMap, operation]);
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {formData.isPaid && (
                     ...
                     <div className="ml-auto p-2 bg-gray-100 dark:bg-gray-800 rounded-lg font-semibold text-lg">
                        {t('totalAmount')}: {formatCurrency(calculatedTotals.totalAmount, settings.localization)}
                    </div>
                </div>
