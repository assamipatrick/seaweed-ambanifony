            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-700 space-y-4">
                        <h4 className="text-sm font-bold uppercase tracking-widest text-red-700 dark:text-red-200 border-b border-red-300 pb-1 mb-2">{t('bulkWeightConsumed')}</h4>
                        <div className="grid grid-cols-1 gap-4">
                            <Input label={`${t('warehouse_weightKg')}`} type="number" step="any" value={formData.consumedWeightKg} onChange={e => handleChange('consumedWeightKg', e.target.value)} error={errors.consumedWeightKg} required />
                    ...
                    <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-700 space-y-4">
                        <h4 className="text-sm font-bold uppercase tracking-widest text-green-700 dark:text-green-200 border-b border-green-300 pb-1 mb-2">{t('pressedWeightObtained')}</h4>
                        <div className="grid grid-cols-1 gap-4">
                             <Input label={`${t('warehouse_weightKg')}`} type="number" step="any" value={formData.producedWeightKg} onChange={e => handleChange('producedWeightKg', e.target.value)} error={errors.producedWeightKg} required />
